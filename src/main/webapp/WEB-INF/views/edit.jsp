...
<html>
<head>
  <title>Task Manager | Task Edit Page</title>
					...
					<div class="col-md-12">
						<div class="box box-info">
							<div class="box-header with-border">
								<h3 class="box-title">Task Edit Form</h3>
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input name="taskTitle" type="text"
													...
													placeholder="Task Title" value="${ item.getTaskTitle() }">
											</div>
										</div>
											...
											<div class="col-sm-10">
												<div class="input-group date">
													...
													<input type="text" class="form-control pull-right"
														id="datepicker" name="taskDueDate" value="${ item.getTaskDueDate() }">
												</div>
											</div>
											<!-- /.input group -->
										</div>
